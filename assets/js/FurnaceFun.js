...
// use a for loop for Math.random
    ...
    let First = document.getElementById('btn-1').textContent = answersOne[x].text
    let Second = document.getElementById('btn-2').textContent = answersTwo[x].text
    let Third = document.getElementById('btn-3').textContent = answersThree[x].text
...
const answersOne = [{text: "Harpy", correct: false}, {text: "Foxes", correct: true}, {text: "Two", correct: false}]

const answersTwo = [{text: "Phoenix", correct: true}, {text: "Leopards", correct: false}, {text: "Three", correct: true}]

const answersThree = [{text: "Cucco", correct: false}, {text: "Falcons", correct: false}, {text: "Four", correct: false}]